...
public class Ejer3_Guia {
	...
	public static void Ej3b() {
        ...
        List<Integer> numerosLista = Funcion.funciones.filtrarNumeros(datos);
	    ...
	    try {
	        ...
	        for( String num : numeros ) {
	        	try {
	                ...
	                if( Funcion.funciones.esPrimo(numero) ) {
	                    numerosPrimos.add(numero);
	                }
	            } catch (NumberFormatException e) {
	                // Ignorar l�neas que no se pueden convertir a enteros
	            }
	        }
	...
	public static void Ej3g() {
    	...
    	try {
    		for( int i = 0 ; i < 10 ; i++ ) {
    			ps.println("Ingrese una palabra con �: ");
